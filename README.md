...
│   ├── 05_experimental_validation.ipynb    # PhD thesis experiments
│   ├── 06_interpretability_analysis.ipynb  # Feature importance & explanations
│   └── 07_generative_path_optimization.ipynb # Generative models for intermediates
├── src/
